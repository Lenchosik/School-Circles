...
public class MainApp extends Application {
    ...
    public MainApp() {
        ...
        ClubData.add(new Club("Лицей №1", "Клуб информатики \"Питоны\""));
        ClubData.add(new Club("МБОУ СОШ №7", "Футбольный клуб \"Магнат\""));
        ClubData.add(new Club("МБОУ СОШ №3", "Театральный кружок \"Лицедеи\""));
        ClubData.add(new Club("Училище №4", "Книжный клуб \"Мемология\""));
        ClubData.add(new Club("МБОУ СОШ №5", "Клуб рисования \"Берег\""));
        ClubData.add(new Club("Лицей №1", "Юмористический клуб \"Купил - Включил - Не работает\""));
        ClubData.add(new Club("МБОУ СОШ №7", "Шахматный клуб \"Рок\""));
        ClubData.add(new Club("МБОУ СОШ №3", "Клуб фотографии \"Горизонт\""));
        ClubData.add(new Club("Училище №4", "Музыкальный кружок \"Мерлин\" "));
    }
    ...
    public void start(Stage primaryStage) {
        ...
        this.primaryStage.getIcons().add(new Image("schoolhat_icon.png"));
